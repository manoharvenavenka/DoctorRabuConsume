          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            <ul className="navbar-nav">
              <li className="nav-item">
                <Link to="/admin/adminhome" className="nav-link">Home</Link>
              </li>
              <li className="nav-item">
                <Link to="/admin/viewDoctors" className="nav-link" >Doctors</Link>
              </li>
              <li className="nav-item">
                <Link to="/admin/addMedicines" className="nav-link" >Medicines</Link>
              </li>
